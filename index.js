...
function onMessageHandler (target, context, msg, self) {
    ...
    var commandList = commandName.split(/\s+/g);

    // Now let's set up our commands.
    commandList.forEach(commandName => {

  // Let's do our jump command first.
  ...
  client.say(target, `/me [TWITCH PLAYS] ${context.username} made the character jump!`); // This tells the player they successfully jumped.
...
if (commandName.toLowerCase() === 'attack') { 
    robot.keyTap("x");  
    client.say(target, `/me [TWITCH PLAYS] ${context.username} made the character attack!`); 
...
if (commandName.toLowerCase() === 'right') { 
  robot.keyTap("right"); 
  client.say(target, `/me  [TWITCH PLAYS] ${context.username} made the character move right!`); 
  console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
} else
  ...
  if (commandName.toLowerCase() === 'left') { 
    robot.keyTap("left"); 
    client.say(target, `/me [TWITCH PLAYS] ${context.username} made the character move left!`); 
    console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
  } else
    ...
    if (commandName.toLowerCase() === 'p2') { 
        robot.keyTap("f2"); 
        client.say(target, `/me [TWITCH PLAYS] ${context.username} made toggled player 2!`); 
        console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
      } else
      ...
      if (commandName.toLowerCase() === 'p2up') { 
          robot.keyTap("w");
          client.say(target, `/me [TWITCH PLAYS] ${context.username} made player 2 move up!`); 
          console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
        } else 
          ...
          if (commandName.toLowerCase() === 'p2left') { 
            robot.keyTap("d");
            client.say(target, `/me [TWITCH PLAYS] ${context.username} made player 2 move left!`); 
            console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
          } else 
            ...
            if (commandName.toLowerCase() === 'p2down') { 
              robot.keyTap("s");
              client.say(target, `/me [TWITCH PLAYS] ${context.username} made player 2 move down!`); 
              console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
            } else 
              ...
              if (commandName.toLowerCase() === 'p2right') { 
                robot.keyTap("a");
                client.say(target, `/me [TWITCH PLAYS] ${context.username} made player 2 move right!`); 
                console.log(`* ${context.username} executed the ` + commandName.toUpperCase() + ` command`);
              } else 
